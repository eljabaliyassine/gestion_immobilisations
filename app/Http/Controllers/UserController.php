...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('users.create', compact('roles', 'societes', 'clients', 'dossiers'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('users.show', compact('user', 'allDossiers'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('users.edit', compact('user', 'roles', 'societes', 'clients', 'dossiers'));
    }
