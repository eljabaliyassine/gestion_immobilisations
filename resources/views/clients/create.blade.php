        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Créer un nouveau client</h5>
                </div>
                    ...
                    <form action="{{ route('clients.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('identifiant_unique') is-invalid @enderror" id="identifiant_unique" name="identifiant_unique" value="{{ old('identifiant_unique') }}">
