        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('contrat.exportCsv.csv') }}" class="btn btn-success me-2">
                            ...
                            <tbody>
                                @forelse($contrats as $contrat)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <p class="text-sm font-weight-bold mb-0">
                                                ...
                                                @if($contrat->fournisseur)
                                                    <br><small class="text-muted">{{ $contrat->fournisseur->nom }}</small>
                                                @endif
                                            </p>
                                        </td>
                                        <td class="align-middle">
                                        ...
                                        <td class="align-middle">
                                            <p class="text-sm font-weight-bold mb-0">{{ number_format($contrat->montant_periodique, 2, ',', ' ') }} DH</p>
                                        </td>
                                        <td class="align-middle">
                                            <p class="text-sm font-weight-bold mb-0">{{ ucfirst($contrat->periodicite) }}</p>
                                        </td>
                                        <td class="align-middle">
                                            <p class="text-sm font-weight-bold mb-0">
                                        ...
                                        <td class="align-middle">
                                            <span class="badge bg-{{ $contrat->statut == 'actif' ? 'success' : ($contrat->statut == 'inactif' ? 'secondary' : 'danger') }}">
                                                {{ ucfirst($contrat->statut) }}
                                            </span>
                                        </td>
                                        <td class="align-middle">
                                            <p class="text-sm font-weight-bold mb-0">{{ $contrat->immobilisations->count() }}</p>
                                        </td>
                                        <td class="align-middle">
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ route('contrats.immobilisations', $contrat->id) }}" class="btn btn-sm btn-primary mx-1" title="Immobilisations">
                                                    <i class="fas fa-link"></i>
                                                </a>
                                                @if($contrat->type == 'leasing')
                                                    <a href="{{ route('contrats.echeances', $contrat->id) }}" class="btn btn-sm btn-success mx-1" title="Échéances">
