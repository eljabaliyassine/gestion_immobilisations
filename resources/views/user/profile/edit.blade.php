            ...
            <div class="bg-gradient-primary rounded-4 p-4 text-white position-relative overflow-hidden">
                ...
                <div class="position-relative">
                    ...
                    <p class="lead mb-0 opacity-90">
                        {{ __('Gérez vos informations personnelles et paramètres de sécurité') }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm mb-4 hover-card">
                <div class="card-header bg-white border-bottom-0 py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="card-title mb-1 fw-semibold">{{ __('Informations Personnelles') }}</h5>
                            <small class="text-muted">{{ __('Mettez à jour vos informations de profil') }}</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm mb-4 hover-card">
                <div class="card-header bg-white border-bottom-0 py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="card-title mb-1 fw-semibold">{{ __('Sécurité du Compte') }}</h5>
                            <small class="text-muted">{{ __('Modifiez votre mot de passe') }}</small>
                        </div>
                    </div>
                </div>
                <div class="card-body p-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    <h6 class="card-title fw-semibold mb-3">
                        ...
                        {{ __('Activité du Compte') }}
                    </h6>
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="text-center p-3 bg-primary bg-opacity-10 rounded-3">
                                <h4 class="text-primary fw-bold mb-1">{{ Auth::user()->created_at->diffInDays() }}</h4>
                                <small class="text-muted">{{ __('Jours') }}</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-center p-3 bg-success bg-opacity-10 rounded-3">
                                <h4 class="text-success fw-bold mb-1">{{ Auth::user()->email_verified_at ? '✅' : '❌' }}</h4>                                <small class="text-muted">{{ __('Vérifié') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    <h6 class="card-title fw-semibold mb-3">
                        ...
                        {{ __('Conseils de Sécurité') }}
                    </h6>
                    <div class="list-group list-group-flush">
                        <div class="list-group-item border-0 px-0 py-2">
                            <i class="fas fa-check-circle text-success me-2"></i>
                            <small>{{ __('Utilisez un mot de passe fort') }}</small>
                        </div>
                        <div class="list-group-item border-0 px-0 py-2">
                            <i class="fas fa-check-circle text-success me-2"></i>
                            <small>{{ __('Vérifiez votre email') }}</small>
                        </div>
                        <div class="list-group-item border-0 px-0 py-2">
                            <i class="fas fa-check-circle text-success me-2"></i>
                            <small>{{ __('Mettez à jour régulièrement') }}</small>
                        </div>
                    </div>
                </div>
            </div>
