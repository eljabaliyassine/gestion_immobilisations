                            ...
                            <div class="col-md-6">
                                ...
                                <select name="client_id" id="client_id" class="form-control @error('client_id') is-invalid @enderror">
                                    ...
                                    @foreach($clients as $client)
                                        <option value="{{ $client->id }}" data-societe-id="{{ $client->societe_id }}" {{ old('client_id') == $client->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="current_dossier_id" id="current_dossier_id" class="form-control @error('current_dossier_id') is-invalid @enderror">
                                    ...
                                    @foreach($dossiers as $dossier)
                                        <option value="{{ $dossier->id }}" data-client-id="{{ $dossier->client_id }}" {{ old('current_dossier_id') == $dossier->id ? 'selected' : '' }}>
