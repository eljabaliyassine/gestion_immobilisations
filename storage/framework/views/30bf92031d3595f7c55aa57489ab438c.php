...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('parametres.comptescompta.create')); ?>" class="btn btn-primary btn-lg shadow-sm">
                ...
                <form method="GET" class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="search_numero" name="search_numero"
                               value="<?php echo e(request('search_numero')); ?>" placeholder="Ex: 2183, 68...">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="search_libelle" name="search_libelle"
                               value="<?php echo e(request('search_libelle')); ?>" placeholder="Rechercher par nom...">
                    </div>
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="filter_type" name="filter_type">
                            ...
                            <option value="actif" <?php echo e(request('filter_type') == 'actif' ? 'selected' : ''); ?>>Actif</option>
                            <option value="passif" <?php echo e(request('filter_type') == 'passif' ? 'selected' : ''); ?>>Passif</option>
                            <option value="charge" <?php echo e(request('filter_type') == 'charge' ? 'selected' : ''); ?>>Charge</option>
                            <option value="produit" <?php echo e(request('filter_type') == 'produit' ? 'selected' : ''); ?>>Produit</option>
                        </select>
                    </div>
                    <div class="col-12">
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('parametres.comptescompta.index')); ?>" class="btn btn-outline-secondary">
    ...
    <?php if(!request()->hasAny(['search_numero', 'search_libelle', 'filter_type'])): ?>
    <div class="row mb-4">
        <div class="col-md-3">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e(\App\Models\CompteCompta::where('type', 'actif')->count()); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e(\App\Models\CompteCompta::where('type', 'passif')->count()); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e(\App\Models\CompteCompta::where('type', 'charge')->count()); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e(\App\Models\CompteCompta::where('type', 'produit')->count()); ?>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                <span class="badge bg-primary"><?php echo e($comptescompta->total() ?? $comptescompta->count()); ?> comptes</span>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $comptescompta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="align-middle">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="account-number-badge me-2">
                                            <code class="bg-light px-3 py-2 rounded fw-bold"><?php echo e($compte->numero); ?></code>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="fw-medium text-dark"><?php echo e($compte->libelle); ?></div>
                                    <small class="text-muted">Compte <?php echo e($compte->numero); ?></small>
                                </td>
                                <td class="text-center">
                                    ...
                                    ?>
                                    <span class="badge bg-<?php echo e($config['class']); ?> d-inline-flex align-items-center">
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="<?php echo e(route('parametres.comptescompta.show', $compte->id)); ?>"
                                           class="btn btn-outline-info btn-sm" title="Voir les détails">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('parametres.comptescompta.edit', $compte->id)); ?>"
                                           class="btn btn-outline-warning btn-sm" title="Modifier">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button type="button" class="btn btn-outline-danger btn-sm"
                                                title="Supprimer" onclick="confirmDelete(<?php echo e($compte->id); ?>)">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                    </div>

                                    <!-- Formulaire de suppression caché -->
                                    <form id="delete-form-<?php echo e($compte->id); ?>"
                                          action="<?php echo e(route('parametres.comptescompta.destroy', $compte->id)); ?>"
                            ...
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <div class="text-muted">
                                        ...
                                        <a href="<?php echo e(route('parametres.comptescompta.create')); ?>" class="btn btn-primary mt-3">
                                            <i class="fas fa-plus me-2"></i>
                                            Créer un compte
                                        </a>
                                    </div>
        ...
        <!-- Pagination -->
        <?php if(method_exists($comptescompta, 'hasPages') && $comptescompta->hasPages()): ?>
            <div class="card-footer bg-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="text-muted small">
                        Affichage de <?php echo e($comptescompta->firstItem()); ?> à <?php echo e($comptescompta->lastItem()); ?>

                        sur <?php echo e($comptescompta->total()); ?> comptes
                    </div>
                    <?php echo e($comptescompta->appends(request()->query())->links()); ?>
