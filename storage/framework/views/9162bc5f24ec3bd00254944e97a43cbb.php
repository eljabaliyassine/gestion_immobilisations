...
<head>
    ...
    <title><?php echo e(config('app.name', 'Gestion Immo')); ?> <?php if (! empty(trim($__env->yieldContent('title')))): ?> - <?php echo $__env->yieldContent('title'); ?> <?php endif; ?></title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark shadow-sm navbar-custom">
            <div class="container-fluid">
                <a class="navbar-brand d-flex align-items-center" href="<?php echo e(url('/')); ?>">
                    ...
                    <span class="d-none d-sm-inline"><?php echo e(config('app.name', 'Gestion Immo')); ?></span>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <?php if(auth()->guard()->check()): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>" href="<?php echo e(route('home')); ?>"><?php echo e(__('Accueil')); ?></a>
                            </li>
                            ...
                            <?php if(Auth::user()->current_dossier_id): ?>
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarImmobilisationsDropdown">
                                        <li><a class="dropdown-item" href="<?php echo e(route('immobilisations.index')); ?>">
                                            <i class="bi bi-list me-2"></i>Liste
                                        </a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('immobilisations.create')); ?>">
                                            <i class="bi bi-plus-circle me-2"></i>Ajouter
                                        </a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('amortissements.plan')); ?>">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarContratsDropdown">
                                        <li><a class="dropdown-item" href="<?php echo e(route('contrats.index', ['type' => 'location'])); ?>">
                                            <i class="bi bi-key me-2"></i>Locations
                                        </a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('contrats.index', ['type' => 'leasing'])); ?>">
                                            <i class="bi bi-credit-card me-2"></i>Crédit-Bail
                                        </a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('contrats.index', ['type' => 'maintenance'])); ?>">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(request()->routeIs('inventaires.*') ? 'active' : ''); ?>" href="<?php echo e(route('inventaires.index')); ?>">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarParametresDropdown">
                                        <li><a class="dropdown-item" href="<?php echo e(route('parametres.familles.index')); ?>">
                                            <i class="bi bi-collection me-2"></i>Familles
                                        </a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('parametres.sites.index')); ?>">
                                            <i class="bi bi-geo-alt me-2"></i>Sites
                                        </a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('parametres.services.index')); ?>">
                                            <i class="bi bi-diagram-3 me-2"></i>Services
                                        </a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('parametres.fournisseurs.index')); ?>">
                                            <i class="bi bi-truck me-2"></i>Fournisseurs
                                        </a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('parametres.prestataires.index')); ?>">
                                            <i class="bi bi-people me-2"></i>Prestataires
                                        </a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('parametres.comptescompta.index')); ?>">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarExportsDropdown">
                                        <li><a class="dropdown-item" href="<?php echo e(route('exports.index')); ?>">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarAdminDropdown">
                                        <?php if(Auth::user()->isSuperAdmin()): ?>
                                            <li><a class="dropdown-item <?php echo e(request()->routeIs('societes.*') ? 'active' : ''); ?>" href="<?php echo e(route('societes.index')); ?>">
                                                <i class="bi bi-building me-2"></i>Sociétés
                                            </a></li>
                                            <li><a class="dropdown-item <?php echo e(request()->routeIs('clients.*') ? 'active' : ''); ?>" href="<?php echo e(route('clients.index')); ?>">
                                                <i class="bi bi-person-badge me-2"></i>Clients
                                            </a></li>
                                            <li><hr class="dropdown-divider"></li>
                                        <?php endif; ?>
                                        <li><a class="dropdown-item <?php echo e(request()->routeIs('dossiers.*') ? 'active' : ''); ?>" href="<?php echo e(route('dossiers.index')); ?>">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item">
                                    <a class="nav-link px-3" href="<?php echo e(route('login')); ?>">
                                        <i class="bi bi-box-arrow-in-right me-1"></i>
                                        <span class="d-none d-lg-inline"><?php echo e(__('Connexion')); ?></span>
                                    </a>
                                </li>
                            <?php endif; ?>
                        <?php else: ?>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle px-3" href="#" id="navbarDossierDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <?php if(Auth::user()->currentDossier): ?>
                                        <i class="bi bi-folder-check me-1"></i>
                                        <span class="d-none d-md-inline"><?php echo e(Str::limit(Auth::user()->currentDossier->nom, 15)); ?></span>
                                        <span class="d-md-none">Dossier</span>
                                    <?php else: ?>
                                        <i class="bi bi-folder-x me-1"></i>
                                        <span class="d-none d-md-inline"><?php echo e(__('Sélectionner')); ?></span>
                                        <span class="d-md-none">Dossier</span>
                                    <?php endif; ?>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDossierDropdown">
                                    <?php $__empty_1 = true; $__currentLoopData = Auth::user()->dossiers()->where('est_cloture', 0)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dossier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li>
                                            <form action="<?php echo e(route('dossiers.storeSelection')); ?>" method="POST" class="d-inline w-100">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="dossier_id" value="<?php echo e($dossier->id); ?>">
                                                <button type="submit" class="dropdown-item <?php echo e(Auth::user()->current_dossier_id == $dossier->id ? 'active' : ''); ?>">
                                                    <i class="bi bi-folder me-2"></i><?php echo e($dossier->nom); ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <li><span class="dropdown-item-text">
                                            <i class="bi bi-exclamation-triangle me-2"></i><?php echo e(__('Aucun dossier disponible')); ?>

                                        </span></li>
                                    <?php endif; ?>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('dossiers.index')); ?>">
                                        <i class="bi bi-gear me-2"></i><?php echo e(__('Gérer les Dossiers')); ?>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                        ...
                                        <i class="bi bi-box-arrow-right me-2"></i><?php echo e(__('Déconnexion')); ?>
...
<?php /**PATH C:\laragon\www\gestion_immobilisations\resources\views/layouts/app.blade.php ENDPATH**/ ?>