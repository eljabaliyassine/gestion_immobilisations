        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('contrats.update', $contrat->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="reference" name="reference" value="<?php echo e(old('reference', $contrat->reference)); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type" required>
                                        ...
                                        <option value="maintenance" <?php echo e(old('type', $contrat->type) == 'maintenance' ? 'selected' : ''); ?>>Maintenance</option>
                                        <option value="location" <?php echo e(old('type', $contrat->type) == 'location' ? 'selected' : ''); ?>>Location</option>
                                        <option value="leasing" <?php echo e(old('type', $contrat->type) == 'leasing' ? 'selected' : ''); ?>>Crédit-bail</option>
                                        <option value="autre" <?php echo e(old('type', $contrat->type) == 'autre' ? 'selected' : ''); ?>>Autre</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="prestataire_id" name="prestataire_id">
                                        ...
                                        <?php $__currentLoopData = $prestataires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prestataire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($prestataire->id); ?>" <?php echo e(old('prestataire_id', $contrat->prestataire_id) == $prestataire->id ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="fournisseur_id" name="fournisseur_id">
                                        ...
                                        <?php $__currentLoopData = $fournisseurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fournisseur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($fournisseur->id); ?>" <?php echo e(old('fournisseur_id', $contrat->fournisseur_id) == $fournisseur->id ? 'selected' : ''); ?>>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date_debut" name="date_debut" value="<?php echo e(old('date_debut', $contrat->date_debut ? $contrat->date_debut->format('Y-m-d') : '')); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="date_fin" class="form-control-label">Date de fin</label>
                                    <input type="date" class="form-control" id="date_fin" name="date_fin" value="<?php echo e(old('date_fin', $contrat->date_fin ? $contrat->date_fin->format('Y-m-d') : '')); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="date_prochaine_echeance" class="form-control-label">Date prochaine échéance</label>
                                    <input type="date" class="form-control" id="date_prochaine_echeance" name="date_prochaine_echeance" value="<?php echo e(old('date_prochaine_echeance', $contrat->date_prochaine_echeance ? $contrat->date_prochaine_echeance->format('Y-m-d') : '')); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="montant_periodique" name="montant_periodique" value="<?php echo e(old('montant_periodique', $contrat->montant_periodique)); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="periodicite" name="periodicite" required>
                                        ...
                                        <option value="mensuel" <?php echo e(old('periodicite', $contrat->periodicite) == 'mensuel' ? 'selected' : ''); ?>>Mensuel</option>
                                        <option value="trimestriel" <?php echo e(old('periodicite', $contrat->periodicite) == 'trimestriel' ? 'selected' : ''); ?>>Trimestriel</option>
                                        <option value="semestriel" <?php echo e(old('periodicite', $contrat->periodicite) == 'semestriel' ? 'selected' : ''); ?>>Semestriel</option>
                                        <option value="annuel" <?php echo e(old('periodicite', $contrat->periodicite) == 'annuel' ? 'selected' : ''); ?>>Annuel</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="statut" name="statut" required>
                                        <option value="actif" <?php echo e(old('statut', $contrat->statut) == 'actif' ? 'selected' : ''); ?>>Actif</option>
                                        <option value="inactif" <?php echo e(old('statut', $contrat->statut) == 'inactif' ? 'selected' : ''); ?>>Inactif</option>
                                        <option value="termine" <?php echo e(old('statut', $contrat->statut) == 'termine' ? 'selected' : ''); ?>>Terminé</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3"><?php echo e(old('description', $contrat->description)); ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($contrat->document_path): ?>
                                <div class="mb-2">
                                    <a href="<?php echo e(asset('storage/' . $contrat->document_path)); ?>" target="_blank" class="btn btn-sm btn-outline-info">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="duree_mois" name="duree_mois" value="<?php echo e(old('duree_mois', $detailCreditBail->duree_mois ?? '')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="valeur_residuelle" class="form-control-label">Valeur résiduelle (DH) <span class="text-danger">*</span></label>
                                        <input type="number" step="0.01" class="form-control" id="valeur_residuelle" name="valeur_residuelle" value="<?php echo e(old('valeur_residuelle', $detailCreditBail->valeur_residuelle ?? 0)); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="taux_interet_periodique" class="form-control-label">Taux d'intérêt périodique (%)</label>
                                        <input type="number" step="0.001" class="form-control" id="taux_interet_periodique" name="taux_interet_periodique" value="<?php echo e(old('taux_interet_periodique', $detailCreditBail->taux_interet_periodique ?? '')); ?>">
                                    </div>
                                </div>
                            </div>
                            
                            <?php if($contrat->type == 'leasing' && isset($detailCreditBail)): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gestion_immobilisations\resources\views/contrats/edit.blade.php ENDPATH**/ ?>